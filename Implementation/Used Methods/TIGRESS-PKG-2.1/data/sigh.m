...
fprintf('****************************** \n \n')
freq=tigress(dataTest1,'R',R,'alpha',alpha,'L',L);
display(freq(:,:,1))
fprintf('*************************************** \n')
...
fprintf('********************************************* \n \n')
edges=predict_network(scores,dataTest1.tf_index,'cutoff',15);
display(edges)
pause 
...
fprintf('********************************************* \n \n')
[TPR FPR PREC REC L AUROC AUPR] = GRNInferenceEvaluation(dataTest1.gold_edges_num,edges);
display(AUPR)
display(AUROC)
pause
fprintf('.................................................\n')
